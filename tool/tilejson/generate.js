...
const generatedLocation = path.resolve(rootLocation, 'lib', 'tilejson', 'gen', 'tilejson.gen.dart');

const referenceFolder = path.resolve(rootLocation, 'references', 'tilejson');
...
const generateDartCode = (references) => {
  ...
  code.push(`// Generated by tool/tilejson/generate.js`);
  code.push('');
