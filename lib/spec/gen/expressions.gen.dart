...
// Generated by tool/style/generate_expressions.dart

import '../spec.dart';
import '../expression/definitions/_definitions.dart';
...
class CollatorExpressionExpression extends Expression<Collator> {
  ...
  factory CollatorExpressionExpression.fromJson(List<dynamic> args, {Type? type}) {
    ...
    arg0 = (
      ...
      diacriticSensitive: args[i]['diacritic-sensitive'] != null
          ? Expression<bool>.fromJson(args[i]['diacritic-sensitive'])
          : null,
...
class NumberFormatExpression extends Expression<String> {
  ...
  factory NumberFormatExpression.fromJson(List<dynamic> args, {Type? type}) {
    ...
    arg1 = (
      ...
      locale: args[i]['locale'] != null ? Expression<String>.fromJson(args[i]['locale']) : null,
      maxFractionDigits: args[i]['max-fraction-digits'] != null
          ? Expression<int>.fromJson(args[i]['max-fraction-digits'])
          : null,
      minFractionDigits: args[i]['min-fraction-digits'] != null
          ? Expression<int>.fromJson(args[i]['min-fraction-digits'])
          : null,
    );
    i++;
