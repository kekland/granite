...
class SourceVector extends Source with EquatableMixin {
  ...
  factory SourceVector.withDefaults({
    ...
    return SourceVector(
      ...
      url: url,
      tiles: tiles,
      bounds: bounds ?? Vector4(-180,-85.051129,180,85.051129),
  ...
  factory SourceVector.fromJson(Map<String, dynamic> json) {
    return SourceVector.withDefaults(
      ...
      bounds: json['bounds'] != null? vector4FromJson(json['bounds'] as List) : null,
...
class SourceVideo extends Source with EquatableMixin {
  ...
  factory SourceVideo.withDefaults({
    ...
    required List<Vector2> coordinates,
  }) {
    return SourceVideo(
      type: type,
      urls: urls,
  ...
  factory SourceVideo.fromJson(Map<String, dynamic> json) {
    return SourceVideo.withDefaults(
      ...
      coordinates: (json['coordinates'] as List).map((e) => vector2FromJson(e)).toList(),
    );
  }
  ...
  final List<Vector2> coordinates;
...
class LayoutLine extends Layout with EquatableMixin {
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #lineMiterLimit => lineMiterLimit as Property,
    #lineRoundLimit => lineRoundLimit as Property,
    #lineSortKey => lineSortKey as Property,
    #visibility => visibility as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class LayoutSymbol extends Layout with EquatableMixin {
  ...
  factory LayoutSymbol.withDefaults({
    ...
    DataConstantProperty<Vector4>? iconTextFitPadding,
    ...
    DataDrivenProperty<Vector2>? iconOffset,
    ...
    DataDrivenProperty<Vector2>? textOffset,
    ...
    return LayoutSymbol(
      ...
      iconTextFitPadding: iconTextFitPadding?.withDefaultValue(Vector4(0,0,0,0)) ?? DataConstantProperty<Vector4>.value(Vector4(0,0,0,0)),
      iconImage: iconImage,
      ...
      iconOffset: iconOffset?.withDefaultValue(Vector2(0,0)) ?? DataDrivenProperty<Vector2>.value(Vector2(0,0)),
      ...
      textOffset: textOffset?.withDefaultValue(Vector2(0,0)) ?? DataDrivenProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory LayoutSymbol.fromJson(Map<String, dynamic> json) {
    return LayoutSymbol.withDefaults(
      ...
      iconTextFitPadding: json['icon-text-fit-padding'] != null? DataConstantProperty<Vector4>.fromJson(json['icon-text-fit-padding']) : null,
      ...
      iconOffset: json['icon-offset'] != null? DataDrivenProperty<Vector2>.fromJson(json['icon-offset']) : null,
      ...
      textOffset: json['text-offset'] != null? DataDrivenProperty<Vector2>.fromJson(json['text-offset']) : null,
  ...
  final DataConstantProperty<Vector4> iconTextFitPadding;
  ...
  final DataDrivenProperty<Vector2> iconOffset;
  ...
  final DataDrivenProperty<Vector2> textOffset;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #symbolAvoidEdges => symbolAvoidEdges as Property,
    #symbolSortKey => symbolSortKey as Property,
    #symbolZOrder => symbolZOrder as Property,
    #iconAllowOverlap => iconAllowOverlap as Property,
    #iconOverlap => iconOverlap as Property,
    #iconIgnorePlacement => iconIgnorePlacement as Property,
    #iconOptional => iconOptional as Property,
    #iconRotationAlignment => iconRotationAlignment as Property,
    #iconSize => iconSize as Property,
    #iconTextFit => iconTextFit as Property,
    #iconTextFitPadding => iconTextFitPadding as Property,
    #iconImage => iconImage as Property,
    #iconRotate => iconRotate as Property,
    #iconPadding => iconPadding as Property,
    #iconKeepUpright => iconKeepUpright as Property,
    #iconOffset => iconOffset as Property,
    #iconAnchor => iconAnchor as Property,
    #iconPitchAlignment => iconPitchAlignment as Property,
    #textPitchAlignment => textPitchAlignment as Property,
    #textRotationAlignment => textRotationAlignment as Property,
    #textField => textField as Property,
    #textFont => textFont as Property,
    #textSize => textSize as Property,
    #textMaxWidth => textMaxWidth as Property,
    #textLineHeight => textLineHeight as Property,
    #textLetterSpacing => textLetterSpacing as Property,
    #textJustify => textJustify as Property,
    #textRadialOffset => textRadialOffset as Property,
    #textVariableAnchor => textVariableAnchor as Property,
    #textVariableAnchorOffset => textVariableAnchorOffset as Property,
    #textAnchor => textAnchor as Property,
    #textMaxAngle => textMaxAngle as Property,
    #textWritingMode => textWritingMode as Property,
    #textRotate => textRotate as Property,
    #textPadding => textPadding as Property,
    #textKeepUpright => textKeepUpright as Property,
    #textTransform => textTransform as Property,
    #textOffset => textOffset as Property,
    #textAllowOverlap => textAllowOverlap as Property,
    #textOverlap => textOverlap as Property,
    #textIgnorePlacement => textIgnorePlacement as Property,
    #textOptional => textOptional as Property,
    #visibility => visibility as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class Light with EquatableMixin {
  ...
  factory Light.withDefaults({
    ...
    DataConstantProperty<Vector3>? position,
    ...
    return Light(
      ...
      position: position?.withDefaultValue(Vector3(1.15,210,30)) ?? DataConstantProperty<Vector3>.value(Vector3(1.15,210,30)),
  ...
  factory Light.fromJson(Map<String, dynamic> json) {
    return Light.withDefaults(
      ...
      position: json['position'] != null? DataConstantProperty<Vector3>.fromJson(json['position']) : null,
  ...
  final DataConstantProperty<Vector3> position;
...
class PaintFill extends Paint with EquatableMixin {
  ...
  factory PaintFill.withDefaults({
    ...
    DataConstantProperty<Vector2>? fillTranslate,
    ...
    return PaintFill(
      ...
      fillTranslate: fillTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory PaintFill.fromJson(Map<String, dynamic> json) {
    return PaintFill.withDefaults(
      ...
      fillTranslate: json['fill-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['fill-translate']) : null,
  ...
  final DataConstantProperty<Vector2> fillTranslate;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #fillColor => fillColor as Property,
    #fillOutlineColor => fillOutlineColor as Property,
    #fillTranslate => fillTranslate as Property,
    #fillTranslateAnchor => fillTranslateAnchor as Property,
    #fillPattern => fillPattern as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintFillExtrusion extends Paint with EquatableMixin {
  ...
  factory PaintFillExtrusion.withDefaults({
    ...
    DataConstantProperty<Vector2>? fillExtrusionTranslate,
    ...
    return PaintFillExtrusion(
      ...
      fillExtrusionTranslate: fillExtrusionTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory PaintFillExtrusion.fromJson(Map<String, dynamic> json) {
    return PaintFillExtrusion.withDefaults(
      ...
      fillExtrusionTranslate: json['fill-extrusion-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['fill-extrusion-translate']) : null,
  ...
  final DataConstantProperty<Vector2> fillExtrusionTranslate;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #fillExtrusionTranslate => fillExtrusionTranslate as Property,
    #fillExtrusionTranslateAnchor => fillExtrusionTranslateAnchor as Property,
    #fillExtrusionPattern => fillExtrusionPattern as Property,
    #fillExtrusionHeight => fillExtrusionHeight as Property,
    #fillExtrusionBase => fillExtrusionBase as Property,
    #fillExtrusionVerticalGradient => fillExtrusionVerticalGradient as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintLine extends Paint with EquatableMixin {
  ...
  factory PaintLine.withDefaults({
    ...
    DataConstantProperty<Vector2>? lineTranslate,
    ...
    return PaintLine(
      ...
      lineTranslate: lineTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory PaintLine.fromJson(Map<String, dynamic> json) {
    return PaintLine.withDefaults(
      ...
      lineTranslate: json['line-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['line-translate']) : null,
  ...
  /// The geometry's offset. Values are [x, y] where negatives indicate left and up, respectively.
  final DataConstantProperty<Vector2> lineTranslate;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #lineTranslate => lineTranslate as Property,
    #lineTranslateAnchor => lineTranslateAnchor as Property,
    #lineWidth => lineWidth as Property,
    #lineGapWidth => lineGapWidth as Property,
    #lineOffset => lineOffset as Property,
    #lineBlur => lineBlur as Property,
    #lineDasharray => lineDasharray as Property,
    #linePattern => linePattern as Property,
    #lineGradient => lineGradient as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintCircle extends Paint with EquatableMixin {
  ...
  factory PaintCircle.withDefaults({
    ...
    DataConstantProperty<Vector2>? circleTranslate,
    ...
    return PaintCircle(
      ...
      circleTranslate: circleTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory PaintCircle.fromJson(Map<String, dynamic> json) {
    return PaintCircle.withDefaults(
      ...
      circleTranslate: json['circle-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['circle-translate']) : null,
  ...
  /// The geometry's offset. Values are [x, y] where negatives indicate left and up, respectively.
  final DataConstantProperty<Vector2> circleTranslate;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #circleBlur => circleBlur as Property,
    #circleOpacity => circleOpacity as Property,
    #circleTranslate => circleTranslate as Property,
    #circleTranslateAnchor => circleTranslateAnchor as Property,
    #circlePitchScale => circlePitchScale as Property,
    #circlePitchAlignment => circlePitchAlignment as Property,
    #circleStrokeWidth => circleStrokeWidth as Property,
    #circleStrokeColor => circleStrokeColor as Property,
    #circleStrokeOpacity => circleStrokeOpacity as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintHeatmap extends Paint with EquatableMixin {
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #heatmapIntensity => heatmapIntensity as Property,
    #heatmapColor => heatmapColor as Property,
    #heatmapOpacity => heatmapOpacity as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintSymbol extends Paint with EquatableMixin {
  ...
  factory PaintSymbol.withDefaults({
    ...
    DataConstantProperty<Vector2>? iconTranslate,
    ...
    DataConstantProperty<Vector2>? textTranslate,
    ...
    return PaintSymbol(
      ...
      iconTranslate: iconTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
      ...
      textTranslate: textTranslate?.withDefaultValue(Vector2(0,0)) ?? DataConstantProperty<Vector2>.value(Vector2(0,0)),
  ...
  factory PaintSymbol.fromJson(Map<String, dynamic> json) {
    return PaintSymbol.withDefaults(
      ...
      iconTranslate: json['icon-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['icon-translate']) : null,
      ...
      textTranslate: json['text-translate'] != null? DataConstantProperty<Vector2>.fromJson(json['text-translate']) : null,
  ...
  final DataConstantProperty<Vector2> iconTranslate;
  ...
  final DataConstantProperty<Vector2> textTranslate;
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #iconHaloColor => iconHaloColor as Property,
    #iconHaloWidth => iconHaloWidth as Property,
    #iconHaloBlur => iconHaloBlur as Property,
    #iconTranslate => iconTranslate as Property,
    #iconTranslateAnchor => iconTranslateAnchor as Property,
    #textOpacity => textOpacity as Property,
    #textColor => textColor as Property,
    #textHaloColor => textHaloColor as Property,
    #textHaloWidth => textHaloWidth as Property,
    #textHaloBlur => textHaloBlur as Property,
    #textTranslate => textTranslate as Property,
    #textTranslateAnchor => textTranslateAnchor as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintRaster extends Paint with EquatableMixin {
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #rasterBrightnessMin => rasterBrightnessMin as Property,
    #rasterBrightnessMax => rasterBrightnessMax as Property,
    #rasterSaturation => rasterSaturation as Property,
    #rasterContrast => rasterContrast as Property,
    #rasterResampling => rasterResampling as Property,
    #rasterFadeDuration => rasterFadeDuration as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintHillshade extends Paint with EquatableMixin {
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #hillshadeExaggeration => hillshadeExaggeration as Property,
    #hillshadeShadowColor => hillshadeShadowColor as Property,
    #hillshadeHighlightColor => hillshadeHighlightColor as Property,
    #hillshadeAccentColor => hillshadeAccentColor as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
class PaintBackground extends Paint with EquatableMixin {
  ...
  Property getProperty(Symbol field) => switch(field) {
    ...
    #backgroundOpacity => backgroundOpacity as Property,
    _ => throw Exception('Unknown field: $field'),
  };
}
...
sealed class Layout {
  ...
  Property getProperty(Symbol field);
}
